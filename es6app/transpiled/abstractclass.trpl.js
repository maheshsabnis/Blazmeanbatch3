...
var MyDeriveClass = /*#__PURE__*/function (_AbstractClass) {
  _inherits(MyDeriveClass, _AbstractClass);

  var _super = _createSuper(MyDeriveClass);

  function MyDeriveClass() {
    _classCallCheck(this, MyDeriveClass);

    return _super.call(this);
  }

  _createClass(MyDeriveClass, [{
    key: "myDeriveFunction",
    value: function myDeriveFunction() {
